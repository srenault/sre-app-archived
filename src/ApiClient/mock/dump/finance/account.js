export default {
  expenses: [{
    id: 'autres', label: 'Autres', amount: 0, threshold: 200,
  }, {
    id: 'alimentaire', label: 'Alimentaire', amount: 544.79, threshold: 700,
  }, {
    id: 'shopping', label: 'Shopping', amount: 611.05, threshold: 300,
  }],
  id: '1111111111111111',
  type: 'joint_account',
  label: 'XXXXX XXXXXXXXX 01 C/C EUROCOMPTE CONFORT M S RENAULT OU MME P RENAULT',
